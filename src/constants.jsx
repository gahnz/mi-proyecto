...
export const PAYMENT_METHODS = ["Efectivo", "Banco de Chile", "Mercado Pago"];

export const TAX_CATEGORIES = [
  { id: "VENTA", label: "Venta de Servicios/Productos", type: "income" },
  {
    id: "MERCADERIA",
    label: "Compra de Mercadería / Repuestos",
    type: "expense",
  },
  { id: "PREVIRED", label: "Pago previsiones / Sueldos", type: "expense" },
  { id: "REMUNERACION", label: "Remuneraciones / Sueldos", type: "expense" },
  { id: "ARRIENDO", label: "Arriendo de Local", type: "expense" },
  {
    id: "SERVICIOS",
    label: "Servicios Básicos (Luz, Agua, Internet)",
    type: "expense",
  },
